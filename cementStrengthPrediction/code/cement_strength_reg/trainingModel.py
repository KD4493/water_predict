...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            is_null_present,cols_with_missing_values = preprocessor.is_null_present(spc_data)
            ...
            unnecessaryColumns = ['Batch No', 'COMP frst R', 'COMP set', 'Cycle time', 'Description', 'Filter Dust', 'MICOMP wtr',
                                  'New Sand', 'Old Sand', 'Premix time', 'Readymix time', 'SPC set moist', 'Time of storage',
                                  'Tot. Weight', 'Water Type', 'comp frst', 'cost centre', 'moist act', 'temp act']

            # drop unnecessary columns
            spc_data = preprocessor.dropUnnecessaryColumns(spc_data,unnecessaryColumns)
            ...
            spc_good_data = preprocessor.dropUnnecessaryColumns(spc_good_data,todropcolumns)
            ...
            X, Y = preprocessor.separate_label_feature(spc_good_data, label_column_name='TotalWater')
